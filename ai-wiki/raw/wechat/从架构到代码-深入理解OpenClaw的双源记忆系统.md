...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/ZRhjO8xAWr66ic3EqtwSalibJMrVibqpnWiaLepBc9av3sGZN3oDtBDu7IjYH2Q0ZAVOlJuTWHdmicoEsCzPqxsib3z1kPqkP2VJm915MwgTqUl0I/640?wx_fmt=png&from=appmsg#imgIndex=0)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/ZRhjO8xAWr6whaGiaiaLsHvazIwZeQmPnoGxy4zXOeS6CF8xicZsH6iasLIJP3LJjQ7PkE8ibDyaKMJsCymQ15DEnmQHM7pVye0J908cgeicHSF5g/640?wx_fmt=png&from=appmsg#imgIndex=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/ZRhjO8xAWr5qoKpgTDiaQc5O4gT9PHOoHia5pMKHPduvElSXK7zaQ2DlVnVAULBOUkyI6Dytkqn0k67icRX7dzPKmIRtoAVN2lLALnr3SDYvpc/640?wx_fmt=png&from=appmsg#imgIndex=2)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/ZRhjO8xAWr7kNaPyp6LnzKjL0BOiaf5BHa7NPIsdV48G7CB8IiaHobm1icPA77mtKknasEM0p6HQoMPoyQo35Xib4MlNOUibQ9iaEh4rtAFdoI04o/640?wx_fmt=png&from=appmsg#imgIndex=3)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/ZRhjO8xAWr4cIxSIpKXqVQ8omuLnpIhkicfp4xic6gkEwIjYxKeX86VBbCM0PEQzPaSnjG7DsIgpbptnUgSeicKAvZR20MySlBeOF5maI8WkRg/640?wx_fmt=png&from=appmsg#imgIndex=4)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/ZRhjO8xAWr7bcFQibRuTSrnqtxuLRZMBpDmmtYLfTQe9mT9Q2ACmweibEIE0ncmZReWia9zKu86xic5pS5G0jQOukc6lS1zlu26D1HH6iaiaMbtH4/640?wx_fmt=png&from=appmsg#imgIndex=5)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/ZRhjO8xAWr450JfaE4FhpHE0WnjS4V12qpnfVk22aibDHDkqttLicLPnWiacAKMGfhx6kBiakAMxjXSZHiaasNGMUUrYGYNFmGT4T1oJ9KibdGicJg/640?wx_fmt=png&from=appmsg#imgIndex=6)
...
1. 按行遍历，累积字符数（默认约为 tokens * 4 个字符）；
2. 遇到 Markdown 标题（#）时优先断开，保持语义完整；
3. 块之间有重叠（默认约 overlap * 4 个字符），确保跨块检索的连续性。

按照实例文件，分块之后可能会被切分为 2 个块：

| Chunk # | startLine | endLine | text（摘要） | hash |
| --- | --- | --- | --- | --- |
| Chunk 0 | 1 | 12 | # Session: 2026-01-10...<br>## Summary<br>## Key Points<br>- 用户想要每天下午3点... | 7a8b9c... |
| Chunk 1 | 10 | 22 | - 用户偏好使用 Telegram...<br>## Conversation Highlights<br>## Action Items | 3d4e5f... |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| a1b2c3d4e5f6 | memory/2026-01-10-reminders.md | memory | 1 | 12 | 7a8b9c... | text-embedding-3-small | # Session: 2026-01-10 08:00:15 UTC<br>## Summary<br>用户请求设置每日提醒... | [0.0234,-0.0567,...] |
| g7h8i9j0k1l2 | memory/2026-01-10-reminders.md | memory | 10 | 22 | 3d4e5f... | text-embedding-3-small | - 用户偏好使用 Telegram...<br>## Conversation Highlights<br>## Action Items | [0.0345,-0.0678,...] |

3、 chunks_vec 表（sqlite-vec 向量表）：
...
4、 chunks_fts 表（FTS5 全文索引表）：

| text | id | path | source | model | start_line | end_line |
| --- | --- | --- | --- | --- | --- | --- |
| # Session: 2026-01-10... | a1b2c3d4e5f6 | memory/2026-01-10-reminders.md | memory | text-embedding-3-small | 1 | 12 |
| - 用户偏好使用 Telegram... | g7h8i9j0k1l2 | memory/2026-01-10-reminders.md | memory | text-embedding-3-small | 10 | 22 |
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/ZRhjO8xAWr7Me9mOoPsAho8R0RXHiaQGTbBZQoKCxIER6dzX6Db4xmAM2NCwxIsnawib2UMIsH3EDvpicuoxnroUZdOicUau5PHluuAia0Kj0A5o/640?wx_fmt=png&from=appmsg#imgIndex=7)
...
（注：文中部分架构图借助 Nano Banana 2 生成，某些细节可能存在误差。）
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_jpg/ZRhjO8xAWr4EE3sQdVXGY88SbicaKmaVnoMWvE7bX9fqE8DccVV63TdQFLUcRLJ534F2S2x6XdklX5NKVibicr0zDN5ck2LlmPjeiavcshxyGL4/640?wx_fmt=jpeg&from=appmsg#imgIndex=9)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/VY8SELNGe979Bb4KNoEWxibDp8V9LPhyjmg15G7AJUBPjic4zgPw1IDPaOHDQqDNbBsWOSBqtgpeC2dvoO9EdZBQ/640?wx_fmt=other&wxfrom=5&wx_lazy=1&wx_co=1&tp=webp#imgIndex=7)

![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/ZRhjO8xAWr6Yfwibz7TwsGRVWeFaKhulicFqFVItFj4tlo7WIEvNxSchDhwd9icZoDCWOIia12otVtdVmOTZXXZcZOWuhTWl5F0ATYImSTdZHYc/640?wx_fmt=png&from=appmsg#imgIndex=14)

![图片](https://mmbiz.qpic.cn/mmbiz_png/ZRhjO8xAWr69L5WgNvo9hIkLjrMicxeH3jBKS8Bewnibk6AHzOL6r9BkR7dJNmfETmtrOVkqUx0JClLKks0egB2RObXBChABxu45Rd7BtyErk/640?wx_fmt=png&from=appmsg#imgIndex=15)

![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/ZRhjO8xAWr6NAUpwYhQHS7oUuXj8Kq1lfJIbc6YLsm63ibOnhtbkemN1ggRPs2D4iaHutYOKr5Xz1Bk0AWPxosBqaUohDaiaia7SaGdmNiaibQ9mw/640?wx_fmt=png&from=appmsg#imgIndex=16)

![图片](https://mmbiz.qpic.cn/mmbiz_png/VY8SELNGe95pIHzoPYoZUNPtqXgYG2leyAEPyBgtFj1bicKH2q8vBHl26kibm7XraVgicePtlYEiat23Y5uV7lcAIA/640?wx_fmt=other&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1&tp=webp#imgIndex=11)
