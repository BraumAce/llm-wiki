...
publish_date: "2026年4月30日 12:47"
---

# 

> 作者: labuladong
> 来源: https://mp.weixin.qq.com/s/i3yKCZCUtDkTrk4hFZz7NQ
> 发布: 2026年4月30日 12:47

Tips：微信无法放置外链，文中的 link 可以直接去原文网站查看哈：
...
在 LLM 往外输出文本时，还有一个参数叫温度（temperature），控制模型选字时的随机程度。
...
但上下文的容量肯定是有限的，我们一般称这个容量为上下文窗口（Context Window）。
...
这就是所谓的思维链（Chain of Thought，CoT）。
...
所以上下文窗口的大小很重要，窗口太小的话 Agent 跑几轮就把上下文撑满了，前面的信息被截断，模型就「失忆」了。现在主流模型的上下文窗口几乎都到了 1M token，就是为了让 Agent 能跑更久。
