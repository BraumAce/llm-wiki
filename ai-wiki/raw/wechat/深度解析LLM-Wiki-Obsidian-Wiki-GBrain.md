...
publish_date: "2026年5月13日 08:30"
---

# 深度解析LLM Wiki / Obsidian-Wiki / GBrain：Agent时代知识的“自组织”与“自进化”

> 作者: 阿里云开发者
> 来源: https://mp.weixin.qq.com/s/48XpgAMHeaKYj26PrJK-hw
> 发布: 2026年5月13日 08:30
...
1.无数据库依赖：纯 Markdown 文件存储意味着搜索主要依赖 index.md + grep或 QMD。这在数据量小时速度极快，但缺乏复杂查询能力。
...
边（Edges）：存储在专门的 links表中，记录形式为 (Source, Relation_Type, Target)，例如 (Alice, works_at, Alibaba)。
