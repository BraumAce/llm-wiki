...
最初的解决方案是脚本聚合——通过一个 setup-repos.sh 脚本，将前端仓库克隆到后端项目的子目录下：
...
2git submodule update --init reference-projects/pro-components # 只拉取单个
...
回顾这半年的实践，AGENTS.md 的本质是用最小的上下文成本，让 AI 工具获得最大的项目理解。
