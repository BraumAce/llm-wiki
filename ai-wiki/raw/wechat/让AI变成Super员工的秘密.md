...
- 作者: 腾讯技术工程
- 发布时间: 2026年3月23日 17:36
- 原文链接: https://mp.weixin.qq.com/s/JU_PmeOgSNUbNFdl-AIGKQ
...
它能执行，但不一定知道你这个场景里什么算“完成”。 它能输出，但不一定知道你团队真正要的交付物长什么样。 它能连续干很久，但上下文一长，它就会开始“失忆”、偷步骤、压缩细节，最后给你一个
**“看起来做完了，实际上没做全”**的结果。
...
```
做的事，就是把这些
**原本散落在你脑子里、团队经验里、事故教训里的内容，变成 AI 可以执行的岗位 SOP**。
...
所以，
**复杂任务不是“写清楚一次”就结束了，而是必须被设计成“每一步都能自我校验”的流程。**
下面这张图，是我现在最认可的
**Skill 训练闭环**：
...
大家可以看下面这张图，红框圈出来的就是被 AI 漏掉的部分。
**深层页面入口，最容易被 AI“看见但没真正点进去”**
...
```
关键不是这个 checklist 写得多漂亮。 关键是它要变成
**门禁**：
